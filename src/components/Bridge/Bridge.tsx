...
export default function Bridge() {
  ...
  const renderContractsContainers = () => {
    ...
    const resolvedErc20Containers = erc20Components && erc20Components.map((Erc20Container: any, index: number) => <Erc20Container resource={erc20Resources[index]} signer={signer} bridge={domainSelected?.bridge} />);
